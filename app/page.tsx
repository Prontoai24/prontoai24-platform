    ...
    <main className="overflow-hidden">
      <section className="hero-glow grid-paper relative min-h-[720px] border-b border-[var(--line)]">
        <header className="relative z-10 mx-auto flex max-w-7xl items-center justify-between px-6 py-7 lg:px-10">
          ...
          <Link href="/login" className="rounded-full border border-[var(--line)] bg-white/70 px-4 py-2 text-sm font-semibold text-[var(--ink)] backdrop-blur transition hover:border-[var(--cyan)]">Area riservata</Link>
        </header>
