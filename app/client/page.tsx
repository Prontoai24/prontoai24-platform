  ...
  return (
    <main className="min-h-screen bg-[#f7fbff] text-[var(--ink)]">
      ...
      <div className="mx-auto max-w-7xl px-6 py-10 lg:px-10"><p className="text-sm font-bold uppercase tracking-[.18em] text-[var(--blue)]">Area riservata</p><h1 className="mt-2 text-4xl font-bold">{cliente?.company_name || 'Il tuo spazio operativo'}</h1><p className="mt-3 text-[var(--muted)]">Una vista semplice su assistenti, conversazioni e automazioni.</p>
        ...
        <Link href="/client/conversazioni" className="mt-8 flex items-center justify-between rounded-3xl border border-[#b7dce5] bg-[#eaf8fa] p-6 transition hover:-translate-y-0.5 hover:shadow-lg"><div><p className="text-xs font-bold uppercase tracking-[.16em] text-[var(--blue)]">Inbox omnicanale</p><h2 className="mt-2 text-2xl font-bold">Gestisci le conversazioni</h2><p className="mt-2 text-sm text-[var(--muted)]">Filtra WhatsApp, Web, Email e Phone, assegna etichette e prendi il controllo delle chat.</p></div><ArrowUpRight className="shrink-0 text-[var(--blue)]" size={25} /></Link>
