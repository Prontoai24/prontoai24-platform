...
import { Check, Mail, Pencil, PauseCircle, PlayCircle, ShieldCheck, Trash2, UserRound, X } from 'lucide-react'
...
export default function AdminManagement({ initialAdmins }: { initialAdmins: Admin[] }) {
  ...
  async function patchAccount(id: string, payload: Partial<Draft>, successMessage: string) {
    ...
    } catch (error) { setMessage(error instanceof Error ? error.message : 'Operazione non riuscita.') } finally { setSaving(false) }
  }
